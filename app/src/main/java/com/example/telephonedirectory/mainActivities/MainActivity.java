...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phones = databaseHandler.getAllPhone();
...
//            databaseHandler.addPhone(phone);
//        }
    ...
    public void changeList() {
        ...
        newPhone.setPhoneNumber(telephone);

        String oldPhone = preferences.getString("oldPhone","no id");
        databaseHandler.updatePhone(newPhone,oldPhone);
        for (Phone phone : phones) {
    ...
    public void delete(){
        ...
        databaseHandler.deletePhone(String.valueOf(position + 1));
